...
- Lower contrast than entered text but still meets minimum contrast requirements (see `flutter-standards:accessibility`)
...
- `FocusNode` lifecycle (create/dispose): see `flutter-standards:engineering §Guards & Safety`
